...
SpeedTracker.prototype._buildResult = function (data) {
  ...
  // https://github.com/WPO-Foundation/webpagetest/blob/master/www/benchmarks/compare.php
  // added TTFI, TimeToInteractive, firstContentfulPaint, firstMeaningfulPaint
  let result = {
    breakdown: {},
    date: wpt.completed,
    ...
    TTFI: wpt.average.firstView.FirstInteractive,
    TimeToInteractive: wpt.average.firstView.TimeToInteractive,
    firstContentfulPaint: wpt.average.firstView.firstContentfulPaint,
    firstMeaningfulPaint: wpt.average.firstView.firstMeaningfulPaint,
